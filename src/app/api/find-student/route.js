        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    phone = searchParams.get('phone') || '9507489834';
                ...
                case 8: return [2 /*return*/, NextResponse.json({
                        found: false,
                        message: "Phone ".concat(phone, " not found in any collection")
                    })];
                case 9:
                    error_2 = _a.sent();
                    return [2 /*return*/, NextResponse.json({ error: error_2.message }, { status: 500 })];
