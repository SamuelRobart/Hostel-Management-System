...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, location_1, students, formattedStudents, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!location_1) {
                        return [2 /*return*/, NextResponse.json({ success: false, error: 'Location parameter is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, User.find({
                            role: 'student',
                            hostelLocation: new RegExp(location_1, 'i')
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching hostel students:', error_1);
