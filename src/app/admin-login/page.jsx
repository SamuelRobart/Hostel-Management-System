...
export default function AdminLoginPage() {
    ...
    var handleSubmit = function (e) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    data = _a.sent();
                    console.log('Admin login response:', { status: res.status, data: data });
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center px-4 py-12">
