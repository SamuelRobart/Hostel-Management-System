...
export default function StudentProfile() {
    ...
    useEffect(function () {
        var fetchProfile = function () { return __awaiter(_this, void 0, void 0, function () {
            var token, headers, fetchOpts, res, hasLocalUser, data, localUser, roomRes, roomData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch('/api/student/profile', fetchOpts)];
                    case 1:
                        res = _a.sent();
                        if (res.status === 401) {
                    ...
                    case 2:
                        data = _a.sent();
                        if (!data.student) return [3 /*break*/, 5];
                        ...
                        if (!data.student.roomId) return [3 /*break*/, 5];
                        return [4 /*yield*/, fetch("/api/rooms/".concat(data.student.roomId), fetchOpts)];
                    case 3:
                        roomRes = _a.sent();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button onClick={function () { return router.push('/student/dashboard'); }} className="px-4 py-2 rounded-md bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 text-sm">
                Dashboard
              </button>
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm text-blue-800">
                        <div>
                          ...
                          {room.block && " (Block ".concat(room.block, ")")}
                        </div>
                        <div>
                        ...
                        {student.bedNumber && (<div className="flex items-center gap-2 mt-2">
                            <Bed className="h-4 w-4"/>
                            <span className="font-medium">Bed Number:</span> {student.bedNumber}
                          </div>)}
                        {room.amenities && room.amenities.length > 0 && (<div className="mt-2">
