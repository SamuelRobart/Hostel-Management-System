...
export default function IndividualHostelPage() {
    ...
    var _a = useState(null), hostelData = _a[0], setHostelData = _a[1];
    ...
    var occupancyPercentage = ((hostelData.currentOccupancy / hostelData.totalCapacity) * 100).toFixed(1);
    var vacancy = hostelData.totalCapacity - hostelData.currentOccupancy;
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {hostelData.images.map(function (image, index) { return (<div key={index} className="relative h-64 rounded-lg overflow-hidden">
              <img src={image} alt={"".concat(hostelData.location, " Hostel ").concat(index + 1)} className="w-full h-full object-cover"/>
            </div>); })}
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {hostelData.facilities.map(function (facility, index) { return (<div key={index} className="flex items-center p-3 bg-gray-50 rounded-lg">
