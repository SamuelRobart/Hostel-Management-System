...
export default function AddStudentPage() {
    ...
    var _c = useState(''), dateOfBirth = _c[0], setDateOfBirth = _c[1];
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch('/api/students', {
                            ...
                            body: JSON.stringify({ name: name, phone: phone, dateOfBirth: dateOfBirth })
                        })];
                case 2:
                    res = _a.sent();
                ...
                case 3:
                    data = _a.sent();
                    if (data.success) {
                        setMessage("\u2705 Student added successfully! Login with phone: ".concat(phone, " and DOB: ").concat(dateOfBirth));
                        setName('');
                        setPhone('');
                        setDateOfBirth('');
                    }
    ...
    return (<div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-md w-full space-y-8 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input type="text" placeholder="Student Name" value={name} onChange={function (e) { return setName(e.target.value); }} className="w-full px-3 py-2 border border-gray-300 rounded-md" required/>
          ...
          <input type="date" value={dateOfBirth} onChange={function (e) { return setDateOfBirth(e.target.value); }} className="w-full px-3 py-2 border border-gray-300 rounded-md" required/>
        ...
        {message && (<div className="p-4 bg-gray-100 rounded-md text-sm">
            {message}
          </div>)}
