...
import { User, LogOut, Shield, Phone, Calendar } from 'lucide-react';
export default function AdminProfile() {
    var _this = this;
    var router = useRouter();
    var _a = useState(null), admin = _a[0], setAdmin = _a[1];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button onClick={function () { return router.push('/admin/dashboard'); }} className="px-4 py-2 rounded-md bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 text-sm">
                Dashboard
              </button>
