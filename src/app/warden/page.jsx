...
export default function WardenPage() {
    ...
    var _d = useState(null), warden = _d[0], setWarden = _d[1];
    var _e = useState([]), students = _e[0], setStudents = _e[1];
    var _f = useState(false), loadingStudents = _f[0], setLoadingStudents = _f[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch('/api/auth/warden', {
                            method: 'POST',
    ...
    var fetchStudents = function (location) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/api/students/hostel?location=".concat(location))];
                case 2:
                    response = _a.sent();
                ...
                case 3:
                    ...
                    if (data.success && data.students && data.students.length > 0) {
                        console.log("Found ".concat(data.students.length, " students from database"));
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white shadow rounded-lg p-6 mb-6">
            <div className="flex justify-between items-center">
              ...
              <button onClick={function () { return setWarden(null); }} className="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700">
                Logout
              </button>
            </div>
          </div>
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            {loadingStudents ? (<div className="flex items-center justify-center p-8">
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {students.map(function (student, index) { return (<tr key={index} className="hover:bg-gray-50">
    ...
    return (<div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-md w-full space-y-8 p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <input type="password" placeholder="Password" value={password} onChange={function (e) { return setPassword(e.target.value); }} className="w-full px-3 py-2 border border-gray-300 rounded-md" required/>
