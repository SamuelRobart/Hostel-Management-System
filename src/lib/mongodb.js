...
var connectionString = MONGODB_URI || 'mongodb://127.0.0.1:27017/hostel-management';
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!cached.promise) {
                        ...
                        cached.promise = mongoose.connect(connectionString, opts).then(function (mongoose) {
